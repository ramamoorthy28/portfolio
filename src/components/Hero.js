...
export default function Hero() {
  const config = {
    ...
    social : {
      twitter: "http://twitter.com,ram_28",
      instagram: "http://facebook.com,ram_28",
      linkedin: "https://www.linkedin.com/in/ramamoorthy-d-568900218/"
   ...
   return <section className='flex flex-col md:flex-row px-5 py-32 bg-primary justify-center'>
       <div className='md:w-1/2 flex flex-col'>
        <h1 className=' text-white text-6xl font-hero-font'>Hi, <br/> Im <span className='text-black'>Ram</span>
